 ...
 *
 */
public class MdmTeacherInfo extends MesDataEntity<MdmTeacherInfo>{
	...
	private String parentName;//所属名称
	...
	public String toString() {
		return "MdmTeacherInfo [id=" + id + ", code=" + code + ", name=" + name + ", parent_code=" + parentCode + "]";
	}
